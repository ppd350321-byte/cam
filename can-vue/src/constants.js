...
export const MOCK_USERS = [
    { id: 'u1', name: 'Alice Zhang', phone: '13800138000', tier: 'PLATINUM', balance: 450.00, points: 1200, lastVisit: '2023-10-25' },
    { id: 'u2', name: 'Bob Li', phone: '13900139000', tier: 'GOLD', balance: 120.50, points: 540, lastVisit: '2023-10-24' },
    { id: 'u3', name: 'Charlie Wang', phone: '13700137000', tier: 'REGULAR', balance: 0.00, points: 50, lastVisit: '2023-10-20' },
    { id: 'u4', name: 'Diana Chen', phone: '13600136000', tier: 'SILVER', balance: 85.00, points: 300, lastVisit: '2023-10-25' },
];
...
export const MOCK_ORDERS = [
    {
        ...
        totalAmount: 25, status: 'COMPLETED', createdAt: '2023-10-26T11:30:00', paymentMethod: 'Balance'
    },
    {
        id: 'ord-1002', userId: 'u2', userName: 'Bob Li',
        items: [{ id: 'p2', name: 'Beef Noodle Soup', quantity: 2, price: 30 }],
        totalAmount: 60, status: 'PREPARING', createdAt: '2023-10-26T11:45:00', paymentMethod: 'WeChat'
    },
    {
        ...
        totalAmount: 20, status: 'PENDING', createdAt: '2023-10-26T12:05:00', paymentMethod: 'Alipay'
    },
];
